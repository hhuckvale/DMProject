...
def time_above_threshold(corrected_tempVolt, sampleTimes, sigma_b, n):
    threshold = n * sigma_b
...
for event_index, corrected_tempVolt in enumerate(corrected_tempVolts):
    ...
    time_above, first_cross, second_cross = time_above_threshold(corrected_tempVolt, sampleTimes, sigma_b_array[event_index], n)
...
df = pd.DataFrame({
            ...
            'total_time_above': all_total_time_above,
